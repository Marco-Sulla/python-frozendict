...
statements = (
    {"code": "x.get(key)", "setup": "key = getUuid()", "iterations": 13000000, "name": "d.get(key)", "size_affected": False}, 
    {"code": "x['12323f29-c31f-478c-9b15-e7acc5354df9']", "setup": "key = getUuid()", "iterations": 10000000, "name": "d[key]", "size_affected": False}, 
    ...
    {"code": "pickle.dumps(x)", "setup": "import pickle","iterations": 5000, "name": "pickle.dumps(d)", "size_affected": True},  
    {"code": "pickle.loads(dump)", "setup": "import pickle; dump = pickle.dumps(x)","iterations": 4000, "name": "pickle.loads(dump)", "size_affected": True},  
    ...
    {"code": "for _ in x.keys(): pass", "setup": "pass","iterations": 100000, "name": "d.keys()", "size_affected": True},  
    {"code": "for _ in x.values(): pass", "setup": "pass","iterations": 100000, "name": "d.values()", "size_affected": True},  
