...
class frozendict(Mapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    def copy(self: frozendict[_KT, _VT]) -> frozendict[_KT, _VT]: ...
    def __copy__(self: frozendict[_KT, _VT]) -> frozendict[_KT, _VT]: ...
    def __deepcopy__(self: frozendict[_KT, _VT]) -> frozendict[_KT, _VT]: ...
    ...
    def setdefault(self: frozendict[_KT, _VT], key: _KT, default: _VT) -> frozendict[_KT, _VT]: ...
